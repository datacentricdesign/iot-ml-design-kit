...
- [ ] You will be asked later on to evaluate activities based on their timestamp and a short clip. Inform all test subjects of the fact that you will be using camera footage. It is very important that you have your subjects’ [written consent](../iot-ml-design-kit
/consent_form_for_data_collection.pdf) to appear in these recordings. 
